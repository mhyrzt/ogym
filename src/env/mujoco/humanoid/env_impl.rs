...
use super::{env::MujocoHumanoidEnv, config::HumanoidConfig};
...
impl MujocoHumanoidEnv {
    ...
    fn _contact_cost(&self) -> Result<f64, Error> {
        ...
        let clamped_cost = contact_cost.clamp(self.config.contact_cost_range.0, self.config.contact_cost_range.1);
