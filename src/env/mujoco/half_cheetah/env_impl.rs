...
use super::{env::MujocoHalfCheetahEnv, config::HalfCheetahConfig};
...
impl MujocoHalfCheetahEnv {
    ...
    fn _compute_reward(&self, x_velocity: f64, action: &DVector<f64>) -> Result<(f64, std::collections::HashMap<String, f64>), Error> {
